...
export const api = {
  ...
  deleteShopPhoto: (slug, url) => request(`/api/shops/${slug}/photo`, { method: 'DELETE', auth: true, body: { url } }),
  addBean: (slug, data) => request(`/api/shops/${slug}/beans`, { method: 'POST', auth: true, body: data }),
  deleteBean: (slug, beanId) => request(`/api/shops/${slug}/beans/${beanId}`, { method: 'DELETE', auth: true }),
